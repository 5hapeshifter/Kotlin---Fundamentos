package cap8ExcecoesENullSafety
...
fun main() {
    /*
     ...
     Sempre que deixarmos um objeto nulo e formos utilizar um metodo dele, teremos que adicionar os sinais do informando
     o Kotlin se trataremos o 'null' ou se ele deve tratar. Ex: teste?.length ou teste!!.length
     */
