...
*
* Quando usamos as chaves para definir um filtro'{ it.nome == "Lasanha" }', estamos passando um predicado como parametro
* para que o Kotlin consiga entender o que queremos
*/
fun main() {
