package cap5ConceitosDaLinguagem

/**
 * Funcao ControleDeFluxo.ControleDeFluxo.Funcoes.Funcoes.ConceitosDaLinguagemCap5.main e a primeira funcao que sera executada quando o projeto for startado, igual 'PSVM' em java.
 */
fun main() {
